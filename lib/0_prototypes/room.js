/**
 * Add job queue arrays to all rooms
 *
 * sweep array holds all dropped resource ids
 * gather array holds all ids of objects whose interaction is withdraw
 * deposit array holds all ids of objects whose interaction is transfer
 *
 */
Object.defineProperty(Room.prototype, 'sweep', {
	set: function(value) {
		this.memory.sweep = value;
	},
	get: function() {
		if(this.memory.sweep){
			return this.memory.sweep;
    }else{
      return [];
    }
	},
...
Object.defineProperty(Room.prototype, 'gather', {
	set: function(value) {
		this.memory.gather = value;
	},
	get: function() {
		if(this.memory.gather){
			return this.memory.gather;
    }else{
      return [];
    }
	},
...
Object.defineProperty(Room.prototype, 'deposit', {
	set: function(value) {
		this.memory.deposit = value;
	},
	get: function() {
		if(this.memory.deposit){
